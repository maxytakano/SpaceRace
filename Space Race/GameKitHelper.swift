...
@objc class GameKitHelper : NSObject, GKMatchmakerViewControllerDelegate, GKMatchDelegate {
    ...
    */
    ...
    func lookupPlayers() {
        ...
        GKPlayer.loadPlayersForIdentifiers(_match?.playerIDs) { (players, error) -> Void in
            ...
            //GKMatchmaker.sharedMatchmaker().finishMatchmakingForMatch(self._match)
