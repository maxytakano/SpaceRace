...
class ShipSelectionScene: SKScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        let buttonTop = self.size.height * 0.3
        ...
        _currShip.position = CGPoint(x: self.size.width/2, y: self.size.height * 0.70)
        _currShip.setScale(0.8)
...
//            button.color = UIColorFromRGB(0x5687c8)
        ...
        buildButton(buttons[1], icon: icons[1], point: CGPoint(x: buttonCenter-buttonWidth/1.4, y: buttonTop-buttonHeight/2))
        buildButton(buttons[2], icon: icons[2], point: CGPoint(x: buttonCenter+buttonWidth/1.4, y: buttonTop-buttonHeight/2))
        buildButton(buttons[3], icon: icons[3], point: CGPoint(x: buttonCenter-buttonWidth/1.4, y: buttonTop-buttonHeight*1.45))
        buildButton(buttons[4], icon: icons[4], point: CGPoint(x: buttonCenter+buttonWidth/1.4, y: buttonTop-buttonHeight*1.45))
        buildButton(buttons[5], icon: icons[5], point: CGPoint(x: buttonCenter, y: buttonTop-buttonHeight*1.95))
        ...
        // OK button
        _confirm.position = CGPoint(x: buttonCenter, y: buttonTop-buttonHeight*0.975)
        _confirm.setScale(0.8)
